...
senate_list <- list(sen_burden,sen_cost_wth_mort, sen_cost_wth_no_mort,
                    sen_hous_charc,hisp_sen_burden,sen_hisp_calc)

senate_df <- senate_list |>
  map(~ st_drop_geometry(.x)) |>
  reduce(left_join, by = "GEOID")

senate_df <- sen_burden |>
  select(GEOID, geometry) |>
  left_join(senate_df, by = "GEOID") |>
  st_as_sf()
```
