...
state_list <- list(st_burden,st_cost_wth_mort, st_cost_wth_no_mort,
                    st_hous_charc,hisp_st_burden,st_hisp_calc)
...
st_write(
  ...
  here::here(
    "output",
    "state_housing_affordability.gpkg"
  ),
  delete_dsn = TRUE
)
