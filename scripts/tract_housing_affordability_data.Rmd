---
title: "tract_housing_affordablity_data"
...
tract_list <- list(ct_burden,ct_cost_wth_mort, ct_cost_wth_no_mort,
                    ct_hous_charc,hisp_ct_burden,ct_hisp_calc)
...
st_write(
  ...
  here::here(
    "output",
    "tract_housing_affordability.gpkg"
  ),
  delete_dsn = TRUE
)
